...
public class AskDetailsVisitor_Listview_Adapter extends ArrayAdapter<Integer> {
	...
	public AskDetailsVisitor_Listview_Adapter(Context context,
		...
		if (view == null) {
			...
			case VALUE_ASK:
				view = LayoutInflater.from(mContext).inflate(
						R.layout.askdetail_visitor_card_1, parent, false);
				holderAsk = new ViewHolderAsk();
				holderAsk.titletext = (TextView) view
						.findViewById(R.id.askdetail_visitor_card_1_titletext);
				holderAsk.contenttext = (TextView) view
						.findViewById(R.id.askdetail_visitor_card_1_contenttext);
				holderAsk.headimage = (CircleImageView) view
						.findViewById(R.id.askdetail_visitor_card_1_headimage);
				holderAsk.headimagebutton = (ImageButton) view
						.findViewById(R.id.askdetail_visitor_card_1_headimagebutton);
			...
			case VALUE_ANSWER:
				view = LayoutInflater.from(mContext).inflate(
						R.layout.askdetail_visitor_card_2, parent, false);
				holderAnswer = new ViewHolderAnswer();
				holderAnswer.contenttext = (TextView) view
						.findViewById(R.id.askdetail_visitor_card_2_contenttext);
				holderAnswer.headimage = (CircleImageView) view
						.findViewById(R.id.askdetail_visitor_card_2_headimage);
				holderAnswer.headimagebutton = (ImageButton) view
						.findViewById(R.id.askdetail_visitor_card_2_headimagebutton);
				...
				holderAnswer.headimagebutton
						.setImageResource(R.drawable.headbutton_1);
				bitmapUtils.display(holderAnswer.headimage,
						"http://p.qq181.com/cms/1210/2012100413195471481.jpg");
				if (itemButtonClickListener != null) {
					holderAnswer.headimagebutton
							.setOnClickListener(itemButtonClickListener);
			...
			case VALUE_MYANSWER:
				view = LayoutInflater.from(mContext).inflate(
						R.layout.askdetail_visitor_card_3, parent, false);
				holderMyanswer = new ViewHolderMyanswer();
				holderMyanswer.contenttext = (TextView) view
						.findViewById(R.id.askdetail_visitor_card_3_contenttext);
				holderMyanswer.headimage = (CircleImageView) view
						.findViewById(R.id.askdetail_visitor_card_3_headimage);
				holderMyanswer.headimagebutton = (ImageButton) view
						.findViewById(R.id.askdetail_visitor_card_3_headimagebutton);
				...
				holderMyanswer.headimagebutton
						.setImageResource(R.drawable.headbutton_1);
				bitmapUtils.display(holderMyanswer.headimage,
						"http://p.qq181.com/cms/1210/2012100413195471481.jpg");
				if (itemButtonClickListener != null) {
					holderMyanswer.headimagebutton
							.setOnClickListener(itemButtonClickListener);
