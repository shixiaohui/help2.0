...
public class HelpDetailsVisitor_Listview_Adapter_1 extends ArrayAdapter<Integer> {
	private Context mContext;
	private final OnClickListener itemButtonClickListener;
	private FinalBitmap fb;

	public HelpDetailsVisitor_Listview_Adapter_1(Context context,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (view == null) {
			view = LayoutInflater.from(mContext).inflate(
					R.layout.helpdetail_visitor_tab1_listviewitem, parent, false);

			viewHolder = new ViewHolder();
			viewHolder.textView = (TextView) view
					.findViewById(R.id.helpdetail_visitor_tab1_listviewitem_textview);
			viewHolder.headimage = (CircleImageView) view
					.findViewById(R.id.helpdetail_visitor_tab1_listviewitem_headimage);
			viewHolder.headimagebutton = (ImageButton) view
					.findViewById(R.id.helpdetail_visitor_tab1_listviewitem_headimagebutton);
